      ...
      <Container>
        ...
        <Col lg="4" md="4" sm="12">
            ...
            <p className="footer__logo-content">
              Cityride Service Is Biggest Car Selling Renting Company In India In Very Few Years We Create Milestone 
          ...
          <Col lg="3" md="4" sm="12">
            <div className="mb-4">
              ...
              <p className="office__info">111 College Road, ABC, Punjab,India.</p>
              <p className="office__info">Phone: +91 99999 88888</p>
              <p className="office__info">Email: cityride@gmail.com</p>
